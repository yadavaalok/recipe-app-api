...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_recipes_with_existing_tags(self):
        """Test creating a recipe with exisiting tags"""
        tag_indian = Tag.objects.create(user=self.user, name='Indian')
        payload = {
            "title": 'Rasgulla',
            "time_minutes": 30,
            "price": Decimal('3.25'),
            "tags": [{'name': 'Indian'}, {'name': 'Sweets'}]
        }
        res = self.client.post(RECIPE_URL, payload, format='json')
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title="Samosa")
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title="Lemon Juice")
        ...
        r3 = create_recipe(user=self.user, title="Dal Fry")
